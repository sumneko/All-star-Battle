...
function template:do_compile(op)
	...
	table.insert(lua_codes, "if map_update_j then return map_update_j(table.concat(__jass_result__)) or table.concat(__jass_result__) else return table.concat(__jass_result__) end")	
